...
export default {
  ...
  ui: {
    ...
    waitlistPurpose: "We'll only email you when it launches.",
    waitlistMarketing: 'Also send me flight tips and the occasional recommendation.',
    waitlistLegalBefore: 'Unsubscribe anytime. More in our ',
